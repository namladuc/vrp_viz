...
def run_on_instance(instance_name, visualize=False, stdout=True):
...
if __name__ == "__main__":
    ...
    # run_on_instance("data/Vrp-Set-A/A/A-n32-k5.vrp", visualize=False, stdout=True)
    print(*run_on_instance("data/Vrp-Set-A/A/A-n32-k5.vrp", visualize=False, stdout=True))